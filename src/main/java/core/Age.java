...
//     @Parameter(names = { "-n", "--name" }, description = "Your name", required = true)
	...
	new JCommander(new Age(), args);
//            JCommander cli = new JCommander(new Age(), args);
	if (help) {
		new JCommander(new Age(), args).usage();
//                  cli.usage();
		System.exit(0);
		}
	printInfo();
	...
	public static void printInfo() {
		System.out.println("Your name is " + name + ", your age is " + age + " and you are " + (married ? "married :-(" : "not married :-)"));
